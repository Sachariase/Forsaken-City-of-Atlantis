...
namespace db.data
{
    public class XmlData : IDisposable
    {
        ...
        private readonly Dictionary<ushort, KeyDesc> keys;
        ...
        public XmlData(string path = "data")
        {
            ...
            Keys = new ReadOnlyDictionary<ushort, KeyDesc>(
                keys = new Dictionary<ushort, KeyDesc>());
        ...
        public IDictionary<ushort, KeyDesc> Key { get; private set; }
