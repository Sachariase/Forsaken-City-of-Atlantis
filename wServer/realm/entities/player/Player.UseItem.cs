...
namespace wServer.realm.entities.player
{
    partial class Player
    {
        private static readonly ConditionEffect[] NegativeEffs =
        {
            ...
            new ConditionEffect
            {
                Effect = ConditionEffectIndex.PetStasis,
                DurationMS = 0
            },
        };
        ...
        public bool Activate(RealmTime time, Item item, UseItemPacket pkt)
        {
            ...
            foreach (ActivateEffect eff in item.ActivateEffects)
            {
                switch (eff.Effect)
                {
                    ...
                    //Keys!!!
                    //(Bronze)
                    case ActivateEffects.MysteryKeyB:
                        int[] KeyB = new[]
                        {
                            //keys!
                            0xc23,
                        ...
                        for (int i = 5; i < Client.Player.Inventory.Length; i++)
                            ...
                            {
                                Client.Player.Inventory[i] = Client.Player.Manager.GameData.Items[(ushort)KeyB[new Random().Next(0, KeyB.Length)]];
                                Succeed = true;
                                endMethod = false;
                                break;
                            }
                    ...
                    //(Silver)
                    case ActivateEffects.MysteryKeyS:
                        int[] KeyS = new[]
                        {
                            //keys!
                            0x701,
                        ...
                        for (int i = 5; i < Client.Player.Inventory.Length; i++)
                            if (Client.Player.Inventory[i] == null)
                            {
                                Client.Player.Inventory[i] = Client.Player.Manager.GameData.Items[(ushort)KeyS[new Random().Next(0, KeyS.Length)]];
                                Succeed = true;
                                endMethod = false;
                                break;
                            }
                    ...
                    //(Gold)
                    case ActivateEffects.MysteryKeyG:
                        int[] KeyG = new[]
                        {
                            //keys!
                            0xc62,
                        ...
                        for (int i = 5; i < Client.Player.Inventory.Length; i++)
                            if (Client.Player.Inventory[i] == null)
                            {
                                Client.Player.Inventory[i] = Client.Player.Manager.GameData.Items[(ushort)KeyG[new Random().Next(0, KeyG.Length)]];
                                Succeed = true;
                                endMethod = false;
                                break;
                            }
                    ...
                    //Skins!!!
                    //(Bronze)
                    case ActivateEffects.MysterySkinB:
                        int[] SkinB = new[]
                        {
                            //Skins!
                            0xcf8,
                        ...
                        for (int i = 5; i < Client.Player.Inventory.Length; i++)
                            if (Client.Player.Inventory[i] == null)
                            {
                                Client.Player.Inventory[i] = Client.Player.Manager.GameData.Items[(ushort)SkinB[new Random().Next(0, SkinB.Length)]];
                                Succeed = true;
                                endMethod = false;
                                break;
                            }
                    ...
                    //(Silver)
                    case ActivateEffects.MysterySkinS:
                        int[] SkinS = new[]
                        {
                            //Skins!
                            0x7488,
                        ...
                        for (int i = 5; i < Client.Player.Inventory.Length; i++)
                            if (Client.Player.Inventory[i] == null)
                            {
                                Client.Player.Inventory[i] = Client.Player.Manager.GameData.Items[(ushort)SkinS[new Random().Next(0, SkinS.Length)]];
                                Succeed = true;
                                endMethod = false;
                                break;
                            }
                    ...
                    //(Gold)
                    case ActivateEffects.MysterySkinG:
                        int[] SkinG = new[]
                        {
                            //Skins!
                            0x6705,
                        ...
                        //    if (Client.Player.Inventory[i] == null)
                        //    {
                        //        Client.Player.Inventory[i] = Client.Player.Manager.GameData.Items[(ushort)SkinG[new Random().Next(0, SkinG.Length)]];
                        //        Succeed = true;
                        //        endMethod = false;
                        //        break;
                        //    }
                    ...
                    case ActivateEffects.QuestChest:
                        if (!(Owner.Name == "Vault"))
                        {
                            ...
                            SendError("You can only use this item, in your Vault");
                            endMethod = true;
                        ...
                        if (Owner.Name == "Vault")
                        {
                            SendInfo("succes");
                                ...
                                Entity entity = Entity.Resolve(Manager, 0xd8d);
                                entity.Move(X, Y);
                    ...
                    case ActivateEffects.EpicQuestChest:
                        if (!(Owner.Name == "Vault"))
                        {
                        ...
                        if (Owner.Name == "Vault")
                        {
                            ...
                            Entity entity = Entity.Resolve(Manager, 0xd8f);
                            entity.Move(X, Y);
                            Owner.EnterWorld(entity);
                        }
                        break;
