...
namespace wServer.logic.loot
{
    ...
    public class GoldLoot : ILootDef
    {
        ...
        public GoldLoot(int minGold, int maxGold, int v) : this(minGold, maxGold)
        {
            this.v = v;
        }

        public GoldLoot(int v)
        {
            this.v = v;
        }
    ...
    public class ItemLoot : ILootDef
    {
        ...
        public ItemLoot(string item, double probability, int v) : this(item, probability)
        {
            this.v = v;
        }
    ...
    public class EggLoot : ILootDef
    {
        ...
        public EggLoot(EggRarity rarity, double probability, int v) : this(rarity, probability)
        {
            this.v = v;
        }
